    ...
    <div>
      ...
      <div className="bg-gradient-to-b from-violet-900 to-purple-900 text-white  pt-5">
        <div className="px-16 lg:px-32">
          <h1 className="h1Size">Privacy Policy</h1>
          <p>
            Last updated: February 15, 2022 <br /> This Privacy Policy describes
            ...
            privacy rights and how the law protects You. <br /> We use Your
            Personal data to provide and improve the Service. By using the
            Service, You agree to the collection and use of information in
            accordance with this Privacy Policy.
          </p>
          <h1 className="h1Size mt-16"> Interpretation and Definitions</h1>

          <h2 className="h2Size mt-5">Interpretation</h2>
          <p>
            {" "}
          ...
          <h2 className="h2Size mt-5">Definitions</h2>
          <br />
          ...
          <ul className="list-disc ml-8">
            ...
            <li>
              ...
              in this Agreement) refers to Optionsfy LLC, 7901 4th St N, STE 300
          ...
          <h1 className="h1Size mt-8">
            Collecting and Using Your Personal Data
          </h1>
          <h2 className="h2Size mt-6">Types of Data Collected</h2>
          <h2 className="h2Size mt-6">Personal Data</h2>
          <p>
          ...
          <h2 className="h2Size mt-6">Usage Data</h2>
          <p>
          ...
          <h2 className="h2Size mt-6">Tracking Technologies and Cookies</h2>
          <p>
          ...
          <h2 className="h2Size mt-6">Use of Your Personal Data</h2>
          ...
          <h2 className="h2Size mt-6">Transfer of Your Personal Data</h2>
          <p>
          ...
          <h1 className="h1Size mt-6">Disclosure of Your Personal Data</h1>

          <h2 className="h2Size mt-6">Business Transactions</h2>
          <p>
          ...
          <h2 className="h2Size mt-6">Law enforcement</h2>
          <p>
          ...
          <h2 className="h2Size mt-6">Other legal requirements</h2>
          <p>
          ...
          <h2 className="h2Size mt-6">Security of Your Personal Data</h2>
          <p>
          ...
          <h1 className="h1Size mt-6">Children's Privacy</h1>
          <p>
          ...
          <h1 className="h1Size mt-6">Links to Other Websites</h1>
          <p>
          ...
          <h1 className="h1Size mt-6">Changes to this Privacy Policy</h1>
          <p>
          ...
          <h1 className="h1Size mt-6">Contact Us</h1>
          <p>
