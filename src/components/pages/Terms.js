    ...
    <div>
      ...
      <div className="bg-gradient-to-b from-violet-900 to-purple-900 text-white pt-5">
        <div className=" px-16 lg:px-32">
          <div>
            <h1 className="h1Size">TERMS OF SERVICES</h1>
            <p>
              ...
              REMEDIES.
              <br></br>
              Last Revised: 2022-02-16 19:23:25
            </p>
          </div>
          <br />
          <ol className="list-decimal">
            <li>
              <h2 className="h2Size">OVERVIEW</h2>
              <p>
                This Terms of Service Agreement ("Agreement") is entered into by
                and between Optionsfy, registered address 7901 4th St N, STE 300
                St. Petersburg , FL 33702, United States, Florida ("Company")
                and you, and is made effective as of the date of your use of
                this website https://www.optionsfy.com/ ("Site") or the date of
                electronic acceptance.
                <br /> This Agreement sets forth the general terms and
                conditions of your use of the https://www.optionsfy.com/ as well
                as the products and/or services purchased or accessed through
                this Site (the "Services").Whether you are simply browsing or
                using this Site or purchase Services, your use of this Site and
                your electronic acceptance of this Agreement signifies that you
                have read, understand, acknowledge and agree to be bound by this
                Agreement our Privacy policy. The terms "we", "us" or "our"
                shall refer to Company. The terms "you", "your", "User" or
                "customer" shall refer to any individual or entity who accepts
                this Agreement, uses our Site, has access or uses the Services.
                Nothing in this Agreement shall be deemed to confer any
                third-party rights or benefits. <br /> Company may, in its sole
                and absolute discretion, change or modify this Agreement, and
                any policies or agreements which are incorporated herein, at any
                time, and such changes or modifications shall be effective
                ...
                REVISED, DO NOT USE (OR CONTINUE TO USE) THIS SITE OR THE
                SERVICES.
              </p>
            </li>
            ...
            <li>
              <h2 className="h2Size">ELIGIBILITY</h2>
              <p>
                ...
                applicable law, and (iii) are not a person barred from
                purchasing or receiving the Services found under the laws of the
                United States or other applicable jurisdiction. <br />
                If you are entering into this Agreement on behalf of a company
                or any corporate entity, you represent and warrant that you have
                the legal authority to bind such corporate entity to the terms
                and conditions contained in this Agreement, in which case the
            ...
            <li>
              <h2 className="h2Size">INTELLECTUAL PROPERTY</h2>
              <p>
                ...
                Optionsfy in perpetuity, and are subject to copyright,
                trademark, and/or patent protection. <br /> Companies Content is
                provided to you "as is", "as available" and "with all faults"
                for your information and personal, non-commercial use only and
                ...
                written consent of Company. No right or license under any
                copyright, trademark, patent, or other proprietary right or
                license is granted by this Agreement.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                ...
                "AS IS", "AS AVAILABLE" AND "WITH ALL FAULTS". COMPANY, ITS
                ...
                DIRECTORS, EMPLOYEES, AND AGENTS MAKE NO REPRESENTATIONS OR
                WARRANTIES ABOUT (I) THE ACCURACY, COMPLETENESS, OR CONTENT OF
                THIS SITE, (II) THE ACCURACY, COMPLETENESS, OR CONTENT OF ANY
                SITES LINKED (THROUGH HYPERLINKS, BANNER ADVERTISING OR
                OTHERWISE) TO THIS SITE, AND/OR (III) THE SERVICES FOUND AT THIS
                SITE OR ANY SITES LINKED (THROUGH HYPERLINKS, BANNER ADVERTISING
                OR OTHERWISE) TO THIS SITE, AND COMPANY ASSUMES NO LIABILITY OR
                RESPONSIBILITY FOR THE SAME. IN ADDITION, YOU SPECIFICALLY
                ACKNOWLEDGE AND AGREE THAT NO ORAL OR WRITTEN INFORMATION OR
                ADVICE PROVIDED BY COMPANY, ITS OFFICERS, DIRECTORS, EMPLOYEES,
                OR AGENTS, AND THIRD-PARTY SERVICE PROVIDERS WILL (I) CONSTITUTE
                LEGAL OR FINANCIAL ADVICE OR (II) CREATE A WARRANTY OF ANY KIND
                WITH RESPECT TO THIS SITE OR THE SERVICES FOUND AT THIS SITE,
                AND USERS SHOULD NOT RELY ON ANY SUCH INFORMATION OR ADVICE. THE
                FOREGOING DISCLAIMER OF REPRESENTATIONS AND WARRANTIES SHALL
            ...
            <li>
              <h2 className="h2Size">LIMITATION OF LIABILITY</h2>
              <p>
                IN NO EVENT SHALL COMPANY, ITS OFFICERS, DIRECTORS, EMPLOYEES,
                AGENTS, AND ALL THIRD PARTY SERVICE PROVIDERS, BE LIABLE TO YOU
                ...
                HYPERLINKS, BANNER ADVERTISING OR OTHERWISE) TO THIS SITE, (III)
                ...
                OTHERWISE) TO THIS SITE, (VII) ANY VIRUSES, WORMS, BUGS, TROJAN
                HORSES, OR THE LIKE, WHICH MAY BE TRANSMITTED TO OR FROM THIS
                SITE OR ANY SITES LINKED (THROUGH HYPERLINKS, BANNER ADVERTISING
                OR OTHERWISE) TO THIS SITE, (VIII) ANY USER CONTENT OR CONTENT
                THAT IS DEFAMATORY, HARASSING, ABUSIVE, HARMFUL TO MINORS OR ANY
                ...
                COMPANY IS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. IN
                ADDITION, You SPECIFICALLY ACKNOWLEDGE AND agree that any cause
                ...
                <br /> THE FOREGOING LIMITATION OF LIABILITY SHALL APPLY TO THE
            ...
            <li>
              <h2 className="h2Size">INDEMNITY</h2>
              <p>
                You agree to protect, defend, indemnify and hold harmless
                Company and its officers, directors, employees, agents from and
                ...
                incurred by Company directly or indirectly arising from (i) your
                use of and access to this Site; (ii) your violation of any
                provision of this Agreement or the policies or agreements which
                are incorporated herein; and/or (iii) your violation of any
                third-party right, including without limitation any intellectual
                property or other proprietary right. The indemnification
            ...
            <li>
              <h2 className="h2Size">DATA TRANSFER</h2>
              <p>
            ...
            <li>
              <h2 className="h2Size">AVAILABILITY OF WEBSITE</h2>
              <p>
                Subject to the terms and conditions of this Agreement and our
                policies, we shall use commercially reasonable efforts to
                attempt to provide this Site on 24/7 basis. You acknowledge and
                agree that from time to time this Site may be inaccessible for
                any reason including, but not limited to, periodic maintenance,
                ...
                transmission links or other failures. <br />
            ...
            <li>
              <h2 className="h2Size">DISCONTINUED SERVICES</h2>
              <p>
                Company reserves the right to cease offering or providing any of
                the Services at any time, for any or no reason, and without
                prior notice. Although Company makes great effort to maximize
                the lifespan of all its Services, there are times when a Service
                we offer will be discontinued. If that is the case, that product
                or service will no longer be supported by Company. In such case,
                Company will either offer a comparable Service for you to
                migrate to or a refund. Company will not be liable to you or any
                third party for any modification, suspension, or discontinuance
                of any of the Services we may offer or facilitate access to.
              </p>
            </li>
            ...
            <li>
              <h2 className="h2Size">FEES AND PAYMENTS</h2>
              <p>
                You acknowledge and agree that your payment will be charged and
                processed by Optionsfy. You agree to pay any and all prices and
                fees due for Services purchased or obtained at this Site at the
                time you order the Services.
                <br /> Company expressly reserves the right to change or modify
                its prices and fees at any time, and such changes or
                modifications shall be posted online at this Site and effective
                immediately without need for further notice to you.
                <br /> Except as expressly provided in these Terms, all charges
                and payments are non-refundable, non-cancellable, and
                non-creditable, even if your Services are suspended, terminated,
                or transferred prior to the end of the Services term.
              </p>
            </li>
            ...
            <li>
              <h2 className="h2Size">NO THIRD-PARTY BENEFICIARIES</h2>
              <p>
                Nothing in this Agreement shall be deemed to confer any
            ...
            <li>
              <h2 className="h2Size">COMPLIANCE WITH LOCAL LAWS</h2>
              <p>
                ...
                who choose to access this Site are responsible for compliance
            ...
            <li>
              <h2 className="h2Size">GOVERNING LAW</h2>
              <p>
                ...
                States, Florida, to the exclusion of conflict of law rules.
              </p>
            </li>
            ...
            <li>
              <h2 className="h2Size">DISPUTE RESOLUTION</h2>
              <p>
                Any controversy or claim arising out of or relating to these
                Terms of Services will be settled by binding arbitration. Any
                such controversy or claim must be arbitrated on an individual
                basis, and must not be consolidated in any arbitration with any
                claim or controversy of any other party. The arbitration must be
                conducted in United States, Florida, and judgment on the
            ...
            <li>
              <h2 className="h2Size">SEVERABILITY</h2>
              <p>
            ...
            <li>
              <h2 className="h2Size">CONTACT INFORMATION</h2>
              <p>
                If you have any questions about this Agreement, please contact
                us by email or regular mail at the following address: <br />
                Optionsfy <br /> 7901 4th St N, STE 300 St. Petersburg , FL
                33702 <br />
                United States, Florida <br />
                support@optionsfy.com
              </p>
            </li>
          </ol>
        </div>
